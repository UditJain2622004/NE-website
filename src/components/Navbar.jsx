...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: 'Find a Doctor', path: '/doctors' },
    {
      name: 'Our Services',
      path: '/services',
      dropdown: { 'Clinic': "/services/clinic", 'Consultation': "/services/consultation", 'Pharmacy': "/services/pharmacy", 'Day Care Health Service': "/services/day-care-health-service", 'Diagnostics': "/services/diagnostics", 'Occupational Health': "/services/occupational-industrial-health", 'Health Check Packages': "/services/health-check-packages" }
    },
    { name: 'Health Packages', path: '/services/health-check-packages' },
    {
      name: 'Contact',
      path: '/contact',
    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-white ${isScrolled ? 'shadow-lg' : ''}`}>
      ...
      <nav className="lg:hidden flex justify-between items-center px-5 py-3 border-b border-gray-200 bg-white">
        <Link to="/" className="flex items-center">
          <img src="/favicon/textSymbolLogoNoBG.png" alt="Logo" className="h-13 w-23 object-stretch" />
        </Link>
      ...
      <nav className="hidden lg:flex container-custom justify-between items-center py-2">
        <Link to="/" className="flex items-center">
          <img src="favicon/textSymbolLogoNoBG.png" alt="Logo" className="h-15 w-30 object-stretch" />
        </Link>
        ...
        >
          <div className="flex justify-between items-center p-6 border-b border-divider shrink-0">
            <div className="flex items-center">
              <img src="/favicon/textSymbolLogoNoBG.png" alt="Logo" className="h-13 w-23 object-stretch" />
              {/* <img src="/favicon/textSymbolLogoNoBG.png" alt="Logo" className="h-10 w-auto object-contain" /> */}
            </div>
